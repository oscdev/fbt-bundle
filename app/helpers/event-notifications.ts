...
const transporter = nodemailer.createTransport({
    ...
    host: (process.env.NODE_ENV === "production") ? process.env.SMTP_HOST : "smtp.gmail.com",
    port: (process.env.NODE_ENV === "production") ? process.env.SMTP_POST : 587,
    secure: false,
    auth: {
        user: (process.env.NODE_ENV === "production") ? process.env.SMTP_USER : "apps@oscprofessionals.com",
        pass: (process.env.NODE_ENV === "production") ? process.env.SMTP_PASS : "dkfyyywloarcxjyz",
    },
});
